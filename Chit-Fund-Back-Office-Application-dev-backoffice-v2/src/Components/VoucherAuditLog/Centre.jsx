...
import EditedVouchers from "./EditedVoucher.jsx";
import DeletedVouchers from "./DeletedVouchers.jsx";
...
export default function DayBookCentre() {
  ...
  const tabs = ["Edited voucher", "Deleted vouchers"];
  ...
  return (
    <Box sx={{ flexGrow: 1, backgroundColor: "#F5F6FF" }}>
      ...
      >
        ...
        {value === 0 && <EditedVouchers />}
        {value === 1 && <DeletedVouchers />}
      </Paper>
    </Box>
  );
}
