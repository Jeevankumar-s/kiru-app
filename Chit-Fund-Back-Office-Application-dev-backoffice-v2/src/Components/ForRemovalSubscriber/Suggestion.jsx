    ...
    <FullContainer>
      ...
      <VioletContainer>
        <Grid container spacing={2} sx={{ mb: 2 }}>
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            ...
            <LeadDataInput
              fullWidth
              name="drawNumber"
              value={subscriberDetails.drawNumber}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <InputLabelLead>Old Subscriber name</InputLabelLead>
            <LeadDataInput
              select
              fullWidth
              name="subscriberName"
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <InputLabelLead>New Subscriber name</InputLabelLead>
            <LeadDataInput
              select
              fullWidth
              name="newSubscriberName"
              value={subscriberDetails.newSubscriberName}
              onChange={handleInputChange}
              placeholder="Select Subscriber"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            ...
            <RupeeInput
              fullWidth
              name="commission"
              value={subscriberDetails?.commission}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <InputLabelLead>Removal amount</InputLabelLead>
            <RupeeInput
              fullWidth
              name="removalAmount"
              value={subscriberDetails?.removalAmount}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <CustomDatePicker
              label="Removal date"
              value={
                subscriberDetails?.removalDate
                  ? new Date(subscriberDetails?.removalDate)
                  : null
              }
              onChange={(newValue) =>
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <InputLabelLead>Estimated draw number</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="drawNumber"
              value={subscriberDetails.drawNumber}
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            ...
            <RupeeInput
              fullWidth
              name="dividend"
              value={subscriberDetails?.dividend}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <CustomDatePicker
              ...
              value={
                subscriberDetails?.firstNoticeDate
                  ? new Date(subscriberDetails?.firstNoticeDate)
                  : null
              }
              onChange={(newValue) =>
                setSubscriberDetails((prev) => ({
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <CustomDatePicker
              label="Second notice date"
              value={
                subscriberDetails?.secondNoticeDate
                  ? new Date(subscriberDetails?.secondNoticeDate)
                  : null
              }
              onChange={(newValue) =>
                setSubscriberDetails((prev) => ({
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} sm={4} width={"31%"}>
            <InputLabelLead>Reason for removal</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="removalReason"
              value={subscriberDetails.removalReason}
              onChange={handleInputChange}
