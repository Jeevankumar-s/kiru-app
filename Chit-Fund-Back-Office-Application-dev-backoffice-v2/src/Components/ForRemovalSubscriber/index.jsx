        ...
        >
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", width: "100%" }}>
              ...
              <TopModuleName>For Removal</TopModuleName>
            </Box>
            {/* <IconButton
          ...
          <Box>
            ...
            >
              ...
              >
                ...
                {location.pathname ==
                  "/for-removal/suggestion-of-subscriber" && (
                  <SuggestionOfSubscriber />
                )}
                {location.pathname == "/for-removal/approval-of-subscriber" && (
                  <ApprovalOfSubscriber />
                )}
                {location.pathname ==
                  "/for-removal/allocation-of-subscriber" && (
