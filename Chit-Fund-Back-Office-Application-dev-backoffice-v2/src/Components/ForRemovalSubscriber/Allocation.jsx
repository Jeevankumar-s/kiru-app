      ...
      >
        ...
        <Grid item xs={12} sm={4} width={"15%"} flexGrow={1}>
          ...
          <LeadDataInput
            ...
            fullWidth
            name="subscriber"
            value={SubscriberDetails.subscriber}
            onChange={handleInputChange}
        ...
        <Grid sx={{ width: "15%" }} flexGrow={1}>
          <InputLabelLead>Substitution date</InputLabelLead>

          <CustomDatePicker
            label="Start date"
            value={
              SubscriberDetails.substitutionDate
                ? new Date(SubscriberDetails.substitutionDate)
                : null
            }
            onChange={(newValue) =>
        ...
        <Grid sx={{ width: "15%" }} flexGrow={1}>
          <InputLabelLead>Removal Date</InputLabelLead>
