      ...
      <Table sx={{ minWidth: "auto", overflowX: "auto" }}>
        <TableHead>
          ...
          <VoucherTableHeadRow>
            ...
            <TableHeadCell rowSpan={2}>F.D.R No</TableHeadCell>
            <TableHeadCell rowSpan={2}>Bank</TableHeadCell>
            <TableHeadCell rowSpan={2}>Place</TableHeadCell>

            <TableHeadCell colSpan={3} align="center">
              Date of
            </TableHeadCell>
            <TableHeadCell rowSpan={2}>Rate of interest</TableHeadCell>
            <TableHeadCell rowSpan={2}>Period in months</TableHeadCell>
            <TableHeadCell rowSpan={2}>Amount</TableHeadCell>
            <TableHeadCell rowSpan={2}>Maturity value</TableHeadCell>
        ...
        <TableBody>
          {tableData.map((row, idx) => (
            <VoucherTableBodyRow key={idx}>
              ...
              <TableBodyCell>{row.maturity || "-"}</TableBodyCell>
...
export default GroupWarChitTrial;
