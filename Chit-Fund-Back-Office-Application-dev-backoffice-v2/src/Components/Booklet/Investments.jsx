    ...
    <Box>
      <TableContainerWithBorder>
        <Table>
          <TableHead>
            <VoucherTableHeadRow>
              {["Sr. No.", "Items", "Description", "Credit", "Debit"].map(
                (header) => (
      ...
      <VoucherInnerHeadingContainer>
        <VoucherInnerHeading>Addition investments</VoucherInnerHeading>
      </VoucherInnerHeadingContainer>
          ...
          <TableBody>
            {tableData.map((row, idx) => (
              <VoucherTableBodyRow key={idx}>
                ...
                <TableBodyCell>{row.Items || "-"}</TableBodyCell>
                <TableBodyCell>{row.Description || "-"}</TableBodyCell>
                <TableBodyCell>{row.Qty || "-"}</TableBodyCell>
                ...
                <TableBodyCell>{row.dateOfPurchase || "-"}</TableBodyCell>
              </VoucherTableBodyRow>
            ))}
          </TableBody>
        </Table>
      ...
      <VoucherInnerHeadingContainer>
        <VoucherInnerHeading>Deduction investments</VoucherInnerHeading>
      </VoucherInnerHeadingContainer>
          ...
          <TableBody>
            {tableData.map((row, idx) => (
              <VoucherTableBodyRow key={idx}>
                ...
                <TableBodyCell>{row.dateOfSale || "-"}</TableBodyCell>
                <TableBodyCell>
                  {row.SaleAmountAndDeprication || "-"}
                </TableBodyCell>
              </VoucherTableBodyRow>
            ))}
          </TableBody>
      ...
      <VoucherInnerHeadingContainer>
        <VoucherInnerHeading>Trial balance of abstract</VoucherInnerHeading>
      </VoucherInnerHeadingContainer>
      <TableContainerWithBorder>
        <Table>
          <TableHead>
            <VoucherTableHeadRow>
              {["Sr. No.", "Items", "Credit", "Debit"].map((header) => (
                <TableHeadCell key={header}>{header}</TableHeadCell>
              ))}
            </VoucherTableHeadRow>
          </TableHead>
