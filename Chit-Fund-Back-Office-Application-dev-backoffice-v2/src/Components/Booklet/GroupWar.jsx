    ...
    <Box>
      <TableContainerWithBorder>
        <Table>
          <TableHead>
            <VoucherTableHeadRow>
              {["Sr. No.", "Group", "Access remittance", "No prized chit arrear", "Prized chit arrear"].map(
                (header) => (
              ...
              <VoucherTableBodyRow key={idx}>
                ...
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.accessRemittance).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                ...
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.noPrizedChitArrear).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                ...
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.prizedChitArrear).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
