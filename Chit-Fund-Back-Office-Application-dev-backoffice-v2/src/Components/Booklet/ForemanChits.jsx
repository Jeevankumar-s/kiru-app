          ...
          <TableHead>
            <VoucherTableHeadRow>
              {[
                "Sr. No.",
                "Chit group",
                "Call amount paid for prized chit",
                "Prize money",
                "Call amount paid for non-prized chit",
                "Balance payable",
              ...
              <VoucherTableBodyRow key={idx}>
                ...
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.prizedChitAmount || 0).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                ...
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    <LuIndianRupee
                      style={{ marginRight: 4, fontSize: "13px" }}
                    />
                    {Number(row.prizeMoney || 0).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                ...
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    <LuIndianRupee
                      style={{ marginRight: 4, fontSize: "13px" }}
                    />
                    {Number(row.nonPrizedChitAmount || 0).toLocaleString(
                      "en-IN"
                    )}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                ...
                <TableBodyCell>{row.noOfInstalmentsPaid || "-"}</TableBodyCell>
              </VoucherTableBodyRow>
            ))}
            ...
            <VoucherTableBodyRow sx={{ backgroundColor: "#F3F2F5" }}>
              ...
              <TableBodyCell>
                <RupeeFieldContainerInTable>
                  ...
                  Total:{" "}
                  {(finalTotalData?.prizedChitAmount ?? 0).toLocaleString(
                    "en-IN"
                  )}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              ...
              <TableBodyCell>
                <RupeeFieldContainerInTable>
                  <LuIndianRupee style={{ marginRight: 4, fontSize: "13px" }} />
                  Total:{" "}
                  {(finalTotalData?.prizeMoney ?? 0).toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              ...
              <TableBodyCell>
                <RupeeFieldContainerInTable>
                  <LuIndianRupee style={{ marginRight: 4, fontSize: "13px" }} />
                  Total:{" "}
                  {(finalTotalData?.nonPrizedChitAmount ?? 0).toLocaleString(
                    "en-IN"
                  )}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              ...
              <TableBodyCell>
                <RupeeFieldContainerInTable>
                  <LuIndianRupee style={{ marginRight: 4, fontSize: "13px" }} />
                  Total:{" "}
                  {(finalTotalData?.balancePayable ?? 0).toLocaleString(
                    "en-IN"
                  )}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
