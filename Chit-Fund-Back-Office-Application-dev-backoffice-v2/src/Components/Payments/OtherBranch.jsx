    ...
    <FullContainer>
      <Box>
        <Grid container spacing={2} display={"flex"} width={"100%"}>
          <Grid item xs={12} sm={4} width={"20%"} flexGrow={1}>
            <CustomDatePicker
              label="Payment date"
              value={
          ...
          <Grid item xs={12} sm={4} width={"20%"} flexGrow={1}>
            <InputLabelLead>Incidental charges</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="incidentalCharge"
              value={paymentDetails.incidentalCharge || ""}
          ...
          <Grid item xs={12} sm={4} width={"20%"} flexGrow={1}>
            <InputLabelLead>AO.#</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="aoNumber"
              value={paymentDetails.aoNumber || ""}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          <Grid item xs={12} sm={4} width={"20%"} flexGrow={1}>
            ...
            <LeadDataInput
              ...
              value={paymentDetails?.debit?.debitHead}
              onChange={handleInputChange}
              placeholder="Select Credit Head"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"20%"} flexGrow={1}>
            ...
            <LeadDataInput
              ...
              value={paymentDetails?.debit?.description || ""}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
