    ...
    <FullContainer>
      <Box>
        <Grid container spacing={2} display={"flex"} width={"100%"}>
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>Guarantor</InputLabelLead>
            <LeadDataInput
              select
              fullWidth
              name="guarantor"
              value={paymentDetails.guarantor || ""}
              onChange={handleInputChange}
              placeholder="Select"
              variant="outlined"
              size="small"
              SelectProps={{
                ...
                renderValue: (selected) => {
                  ...
                  return selected; // ✅ Just show the selected text
                },
                MenuProps: {
                  PaperProps: {
                    sx: scrollbarStyles,
          ...
          <Grid item xs={12} sm={4} width={"19%"}>
            <InputLabelLead>Document details</InputLabelLead>
            <LeadDataInput
              select
              fullWidth
              name="documentDetails"
              value={paymentDetails.documentDetails || ""}
              onChange={handleInputChange}
              placeholder="Select"
              variant="outlined"
              size="small"
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            ...
            <LeadDataInput
              select
              fullWidth
              name="credit.creditHead"
              value={paymentDetails?.credit?.creditHead}
              onChange={handleInputChange}
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>Bank amount</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="credit.bankAmount"
              value={paymentDetails?.credit?.bankAmount}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>Incidental charge</InputLabelLead>
            <RupeeInput
              fullWidth
              name="credit.incidentalCharge"
              value={paymentDetails?.credit?.incidentalCharge}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>GST(goods & service tax)</InputLabelLead>
            <RupeeInput
              fullWidth
              name="credit.gst"
              value={paymentDetails?.credit?.gst}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>CGST(goods & service tax)</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="debit.cgst"
              value={paymentDetails?.debit?.cgst || ""}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>SCGST(goods & service tax)</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="debit.scgst"
              value={paymentDetails?.debit?.scgst || ""}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>ICGST(goods & service tax)</InputLabelLead>
            <LeadDataInput
              fullWidth
              name="debit.icgst"
              value={paymentDetails?.debit?.icgst || ""}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>Loan amount</InputLabelLead>
            <RupeeInput
              fullWidth
              name="credit.loanAmount"
              value={paymentDetails?.credit?.loanAmount}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            ...
            <RupeeInput
              fullWidth
              name="credit.amount"
              value={paymentDetails?.credit?.amount}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <CustomDatePicker
              label="Range"
              value={
                paymentDetails.range ? new Date(paymentDetails.range) : null
              }
              onChange={(newValue) =>
                setPaymentDetails((prev) => ({
                  ...prev,
          ...
          <Grid item xs={12} sm={4} width={"18%"} flexGrow={1}>
            <InputLabelLead>Loan interest</InputLabelLead>
            <RupeeInput
              fullWidth
              name="credit.amount"
              value={paymentDetails?.credit?.amount}
            ...
            <TableBody>
              {creditTransactions.map((row, idx) => (
                <VoucherTableBodyRow key={idx}>
                  <TableBodyCell>{row.creditHead || "-"}</TableBodyCell>
                  <TableBodyCell
                    style={{
                      display: "flex",
                  ...
                  <TableBodyCell>{row.headId || "-"}</TableBodyCell>
