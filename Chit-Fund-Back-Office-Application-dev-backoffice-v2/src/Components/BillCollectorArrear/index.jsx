...
import BillCollectorArrear from "./BillCollectorArrear.jsx";
      ...
      >
        ...
        >
          <Box sx={{ flexGrow: 1, backgroundColor: "#F5F6FF" }}>
            <TopContainerForAllPages>
              <TopModuleName>Bill collector arrear</TopModuleName>
                ...
                >
                  <Grid container spacing={2} sx={{ mb: 2 }}>
                    ...
                    <Grid
                      ...
                      sx={{ alignItems: "center" }}
                    >
                      <InputLabelLead>Select money collector</InputLabelLead>
