...
const ChitCollectionParticulars = () => {
              ...
              <VoucherTableBodyRow key={idx}>
                ...
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.crr).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.trr).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.rr).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.rcm).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.cca).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.opm).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                <TableBodyCell>
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.upm).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
                <TableBodyCell>
                  {" "}
                  <RupeeFieldContainerInTable>
                    ...
                    />
                    {Number(row.upmLedger).toLocaleString("en-IN")}
                  </RupeeFieldContainerInTable>
                </TableBodyCell>
              </VoucherTableBodyRow>
            ))}
            <VoucherTableBodyRow sx={{ backgroundColor: "#F3F2F5" }}>
              ...
              <TableBodyCell style={{ fontWeight: 500, textAlign: "right" }}>
                <RupeeFieldContainerInTable>
                  ...
                  />
                  {finalTotalData?.crr?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              ...
              <TableBodyCell sx={{ fontWeight: 500 }}>
                <RupeeFieldContainerInTable>
                  ...
                  <LuIndianRupee
                    style={{ marginLeft: 4, marginRight: 2, fontSize: "13px" }}
                  />
                  {finalTotalData?.trr?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              ...
              <TableBodyCell sx={{ fontWeight: 500 }}>
                <RupeeFieldContainerInTable>
                  ...
                  <LuIndianRupee
                    style={{ marginLeft: 4, marginRight: 2, fontSize: "13px" }}
                  />
                  {finalTotalData?.rr?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              <TableBodyCell sx={{ fontWeight: 500 }}>
                <RupeeFieldContainerInTable>
                  ...
                  <LuIndianRupee
                    style={{ marginLeft: 4, marginRight: 2, fontSize: "13px" }}
                  />
                  {finalTotalData?.rcm?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              <TableBodyCell sx={{ fontWeight: 500 }}>
                <RupeeFieldContainerInTable>
                  ...
                  <LuIndianRupee
                    style={{ marginLeft: 4, marginRight: 2, fontSize: "13px" }}
                  />
                  {finalTotalData?.cca?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              <TableBodyCell sx={{ fontWeight: 500 }}>
                <RupeeFieldContainerInTable>
                  ...
                  <LuIndianRupee
                    style={{ marginLeft: 4, marginRight: 2, fontSize: "13px" }}
                  />
                  {finalTotalData?.opm?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              <TableBodyCell sx={{ fontWeight: 500 }}>
                <RupeeFieldContainerInTable>
                  ...
                  <LuIndianRupee
                    style={{ marginLeft: 4, marginRight: 2, fontSize: "13px" }}
                  />
                  {finalTotalData?.upm?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
              <TableBodyCell sx={{ fontWeight: 500 }}>
                <RupeeFieldContainerInTable>
                  ...
                  <LuIndianRupee
                    style={{ marginLeft: 4, marginRight: 2, fontSize: "13px" }}
                  />
                  {finalTotalData?.upmLedger?.toLocaleString("en-IN")}
                </RupeeFieldContainerInTable>
              </TableBodyCell>
            </VoucherTableBodyRow>
          </TableBody>
...
export default ChitCollectionParticulars;
