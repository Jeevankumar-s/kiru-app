...
export default function CRROtherBranch() {
  ...
  const fetchingCollector = async () => {
    const response = await GettingAllCollectors();
    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: "32px" }}>
      ...
      >
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          ...
          <Grid item xs={12} sm={4} width={"31%"} flexGrow={1}>
            <InputLabelLead>Misc amount</InputLabelLead>
            <LeadDataInput
              fullWidth
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          <Grid item xs={12} sm={3} sx={{ width: "22%", flexGrow: 1 }}>
            <InputLabelLead>Cheque no</InputLabelLead>
            <LeadDataInput
              fullWidth
          ...
          <Grid item xs={12} sm={3} sx={{ width: "22%", flexGrow: 1 }}>
            <InputLabelLead>Cheque date</InputLabelLead>
            <CustomDatePicker
              label="Cheque date"
              value={
          ...
          <Grid item xs={12} sm={3} sx={{ width: "22%", flexGrow: 1 }}>
            <InputLabelLead>Bank head</InputLabelLead>
