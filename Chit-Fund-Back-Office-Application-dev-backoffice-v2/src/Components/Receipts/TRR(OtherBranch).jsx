...
export default function TRROtherBranch() {
    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: "32px" }}>
      ...
      >
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          <Grid item xs={12} sm={4} width={"31%"} flexGrow={1}>
            ...
            <LeadDataInput
              select
              fullWidth
              name="transactions.branchName"
              value={ReceiptDetails?.transactions?.branchName}
              onChange={handleInputChange}
              placeholder="Select Branch"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"31%"} flexGrow={1}>
            <EmployeeDetailsPageLabel>Narration</EmployeeDetailsPageLabel>
            <LeadDataInput
              fullWidth
              name="transactions.narration"
              value={ReceiptDetails?.transactions?.narration}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          ...
          <Grid item xs={12} sm={4} width={"31%"} flexGrow={1}>
            <EmployeeDetailsPageLabel>Other</EmployeeDetailsPageLabel>
            <LeadDataInput
              select
              fullWidth
          ...
          <Grid item xs={12} sm={4} width={"31%"} flexGrow={1}>
            <EmployeeDetailsPageLabel>Misc amount</EmployeeDetailsPageLabel>
            <LeadDataInput
              fullWidth
