...
export default function CRROtherBranch({ fetchingCommonDetails }) {
  ...
  const [isOpenAuditModal, setIsOpenAuditModal] = useState(true);
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <TableHeadRow>Draw no</TableHeadRow>
                <TableHeadRow>No of tokens </TableHeadRow>
                <TableHeadRow>Old subscriber</TableHeadRow>
                <TableHeadRow>New subscriber</TableHeadRow>
                <TableHeadRow>Dividend</TableHeadRow>
                <TableHeadRow>Income</TableHeadRow>
                <TableHeadRow>Profession</TableHeadRow>
                <TableHeadRow>Estimated draw no</TableHeadRow>
                <TableHeadRow>Estimated surety details</TableHeadRow>
              </TableRow>
            </TableHead>
            <TableBody>
              {subscriberData &&
