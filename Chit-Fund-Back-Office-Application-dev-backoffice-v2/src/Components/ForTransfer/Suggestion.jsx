    ...
    <FullContainer>
      ...
      <VioletContainer>
        <Grid container spacing={2} sx={{ mb: 2 }}>
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <InputLabelLead>Transfer amount</InputLabelLead>
            <RupeeInput
              fullWidth
              name="transferAmount"
              value={subscriberDetails?.transferAmount}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            <CustomDatePicker
              label="Transfer date"
              value={
                subscriberDetails?.transferDate
                  ? new Date(subscriberDetails?.transferDate)
                  : null
              }
              onChange={(newValue) =>
          ...
          <Grid item xs={12} sm={4} width={"21%"} flexGrow={1}>
            ...
            <LeadDataInput
              fullWidth
              name="callNumber"
              value={subscriberDetails.callNumber}
              onChange={handleInputChange}
              placeholder="Enter"
              variant="outlined"
              size="small"
