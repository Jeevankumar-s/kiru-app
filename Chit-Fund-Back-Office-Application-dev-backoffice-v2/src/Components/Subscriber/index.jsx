...
import AdditionOfSubscriber from "./AdditionOfSubscribers";
import SuggestionOfSubscriber from "./SuggestionOfSubscriber";
import ApprovalOfSubscriber from "./ApproveOfSubscriber";
import AllocationOfSubscriber from "./AllocationOfSubscribers";
        ...
        >
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", width: "100%" }}>
              ...
              <TopModuleName>For new group</TopModuleName>
            </Box>
            {/* <IconButton
          ...
          <Box>
            ...
            >
              ...
              >
                {location.pathname == "/addition-of-subscriber" && (
                  <AdditionOfSubscriber />
                )}
                {location.pathname == "/suggestion-of-subscriber" && (
                  <SuggestionOfSubscriber />
                )}
                {location.pathname == "/approval-of-subscriber" && (
                  <ApprovalOfSubscriber />
                )}
                {location.pathname == "/allocation-of-subscriber" && (
