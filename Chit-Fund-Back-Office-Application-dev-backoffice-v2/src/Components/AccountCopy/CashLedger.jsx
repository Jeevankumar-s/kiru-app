...
const headOptions = [
  ...
  { id: 3, name: "Cash at bank" },
  { id: 4, name: "Cash receipts" },
  { id: 5, name: "Cash payments" },
  { id: 6, name: "Till balance" },
];

const AccountCopyCashLedger = () => {
  ...
  const fetchData = async () => {
    try {
      // Replace with actual API call for cash ledger data
      // const response = await getAccountCopyCashLedger("cash-ledger", 1, 10);
      // setData(response.data);
      console.log("Fetching cash ledger data...");
    } catch (error) {
  ...
  return (
    <Box sx={{ flexGrow: 1, backgroundColor: "#F5F6FF" }}>
      <TopContainerForAllPages>
        <TopModuleName>Cash ledger</TopModuleName>
      </TopContainerForAllPages>
...
export default AccountCopyCashLedger;
