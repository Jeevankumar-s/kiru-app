...
const AccountCopyDecreeDebtors = () => {
  ...
  const fetchData = async () => {
    try {
      // Replace with actual API call for decree debtors data
      // const response = await getAccountCopyDecreeDebtors("decree-debtors", 1, 10);
      // setData(response.data);
      console.log("Fetching decree debtors data...");
    } catch (error) {
  ...
  return (
    <Box sx={{ flexGrow: 1, backgroundColor: "#F5F6FF" }}>
      <TopContainerForAllPages>
        <TopModuleName>Decree debtors</TopModuleName>
      </TopContainerForAllPages>
          ...
          >
            <Grid container spacing={2} sx={{ mb: 2 }}>
              ...
              <Grid
                ...
                sx={{ alignItems: "center" }}
              >
                <InputLabelLead>Select head</InputLabelLead>
                <FormControl fullWidth size="small">
                  <LeadDataInput
                    select
                    fullWidth
...
export default AccountCopyDecreeDebtors;
