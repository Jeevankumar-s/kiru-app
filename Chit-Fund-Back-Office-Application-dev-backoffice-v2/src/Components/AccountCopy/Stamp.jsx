...
const stampOptions = [
  ...
  { id: 2, name: "Revenue stamps" },
  { id: 3, name: "Court fee stamps" },
  { id: 4, name: "Duty stamps" },
  { id: 5, name: "Service stamps" },
];

const AccountCopyStamp = () => {
  ...
  const fetchData = async () => {
    try {
      // Replace with actual API call for stamp data
      // const response = await getAccountCopyStamp("stamp", 1, 10);
  ...
  return (
    <Box sx={{ flexGrow: 1, backgroundColor: "#F5F6FF" }}>
      <TopContainerForAllPages>
        <TopModuleName>Stamp</TopModuleName>
      </TopContainerForAllPages>
        ...
        >
          ...
          >
            <Grid container spacing={2} sx={{ mb: 2 }}>
              ...
              >
                <InputLabelLead>Select stamp</InputLabelLead>
                  ...
                  <LeadDataInput
                    ...
                    SelectProps={{
                      ...
                      renderValue: (selected) => {
                        if (!selected) {
                          return (
                            <span style={{ color: "#9e9e9e" }}>Postal stamps</span>
                          );
                        }
                        const selectedOption = stampOptions?.find(
...
export default AccountCopyStamp;
