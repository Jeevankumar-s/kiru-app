...
const AccountCopySundriesAdvancesLedger = () => {
  ...
  const fetchData = async () => {
    try {
      // Replace with actual API call for sundries & advances ledger data
      // const response = await getAccountCopySundriesAdvancesLedger("sundries-advances-ledger", 1, 10);
      // setData(response.data);
      console.log("Fetching sundries & advances ledger data...");
    } catch (error) {
  ...
  return (
    <Box sx={{ flexGrow: 1, backgroundColor: "#F5F6FF" }}>
      <TopContainerForAllPages>
        <TopModuleName>Sundries & Advances Ledger</TopModuleName>
      </TopContainerForAllPages>
          ...
          >
            <Grid container spacing={2} sx={{ mb: 2 }}>
              ...
              <Grid
                ...
                sx={{ alignItems: "center" }}
              >
                <InputLabelLead>Select advance</InputLabelLead>
                <FormControl fullWidth size="small">
                  <LeadDataInput
                    select
                    fullWidth
                    ...
                    SelectProps={{
                      ...
                      renderValue: (selected) => {
                        ...
                        const selectedOption = advanceOptions?.find(
                          (option) => option.id === selected
                        );
                        return selectedOption ? selectedOption.name : selected;
                      },
            ...
            <TableBody>
              {tableData.map((row, idx) => (
                <VoucherTableBodyRow key={idx}>
                  ...
                  <TableBodyCell>{row.node || "-"}</TableBodyCell>
...
export default AccountCopySundriesAdvancesLedger;
