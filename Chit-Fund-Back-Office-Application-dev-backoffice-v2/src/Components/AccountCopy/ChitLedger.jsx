...
// Chit options
const chitOptions = [
  { id: 1, name: "Chit Group 1" },
  { id: 2, name: "Chit Group 2" },
  { id: 3, name: "Chit Group 3" },
  { id: 4, name: "Chit Group 4" },
  { id: 5, name: "Chit Group 5" },
];

const AccountCopyChitLedger = () => {
  ...
  const fetchData = async () => {
    try {
      // Replace with actual API call for chit ledger data
      // const response = await getAccountCopyChitLedger("chit-ledger", 1, 10);
      // setData(response.data);
      console.log("Fetching chit ledger data...");
    } catch (error) {
  ...
  return (
    <Box sx={{ flexGrow: 1, backgroundColor: "#F5F6FF" }}>
      <TopContainerForAllPages>
        <TopModuleName>Chit ledger</TopModuleName>
      </TopContainerForAllPages>
        ...
        >
          ...
          >
            <Grid container spacing={2} sx={{ mb: 2 }}>
              ...
              >
                <InputLabelLead>Select chit</InputLabelLead>
                  ...
                  <LeadDataInput
                    ...
                    SelectProps={{
                      ...
                      renderValue: (selected) => {
                        ...
                        const selectedOption = chitOptions?.find(
...
export default AccountCopyChitLedger;
