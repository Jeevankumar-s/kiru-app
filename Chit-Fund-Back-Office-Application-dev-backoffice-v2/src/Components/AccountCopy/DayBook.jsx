...
const AccountCopyDayBook = () => {
  const [selectedChitGroup, setSelectedChitGroup] = useState("");
  ...
  const fetchData = async () => {
    try {
      // Replace with actual API call for day book data
      // const response = await getAccountCopyDayBook("day-book", 1, 10);
      // setData(response.data);
      console.log("Fetching day book data...");
    } catch (error) {
                  ...
                  <LeadDataInput
                    ...
                    SelectProps={{
                      ...
                      renderValue: (selected) => {
                        ...
                        const selectedOption = chitGroupOptions?.find(
          ...
          <Table sx={{ width: "100%", overflowX: "auto" }}>
            <TableHead>
              <VoucherTableHeadRow>
                ...
                <TableHeadCell>Reference to receipt in receipt book</TableHeadCell>
                <TableHeadCell>Amount paid</TableHeadCell>
                <TableHeadCell>Forman's commission</TableHeadCell>
                <TableHeadCell>Total expenditure</TableHeadCell>
            ...
            <TableBody>
              {tableData.map((row, idx) => (
                <VoucherTableBodyRow key={idx}>
                  ...
                  <TableBodyCell>{row.accountNo || "-"}</TableBodyCell>
                  <TableBodyCell>{row.subscription || "-"}</TableBodyCell>
                  <TableBodyCell>{row.otherItems || "-"}</TableBodyCell>
                  <TableBodyCell>
                    {row.totalReceipts || "-"}
                  </TableBodyCell>
                  <TableBodyCell>{row.referenceToReceipt || "-"}</TableBodyCell>
                  <TableBodyCell>
                    <RupeeFieldContainerInTable>
                      <LuIndianRupee
                        style={{
                      ...
                      />
                      {row.amountPaid?.toLocaleString("en-IN") || "0"}
                    </RupeeFieldContainerInTable>
                  </TableBodyCell>
                  <TableBodyCell>
                    <RupeeFieldContainerInTable>
                      ...
                      />
                      {row.formansCommission?.toLocaleString("en-IN") || "0"}
                    </RupeeFieldContainerInTable>
                  </TableBodyCell>
                  <TableBodyCell>
                    <RupeeFieldContainerInTable>
                  ...
                  <TableBodyCell>
                    <RupeeFieldContainerInTable>
                      ...
                      />
                      {row.balance?.toLocaleString("en-IN") || "0"}
                    </RupeeFieldContainerInTable>
                  </TableBodyCell>
                </VoucherTableBodyRow>
              ))}
              ...
              <VoucherTableBodyRow sx={{ backgroundColor: "#F3F2F5" }}>
                ...
                <TableBodyCell>
                  {/* <Typography variant="body2" fontWeight="bold" sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    />
                    {(finalTotalData?.totalReceipts ?? 0).toLocaleString("en-IN")}
                  </Typography> */}
                </TableBodyCell>
                <TableBodyCell>
                  {/* <Typography variant="body2" fontWeight="bold">
                ...
                <TableBodyCell>
                  <Typography variant="body2" fontWeight="bold" sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    />
                    {(finalTotalData?.amountPaid ?? 0).toLocaleString("en-IN")}
                  </Typography>
                </TableBodyCell>
                <TableBodyCell>
                  <Typography variant="body2" fontWeight="bold" sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    />
                    {(finalTotalData?.formansCommission ?? 0).toLocaleString("en-IN")}
                  </Typography>
                </TableBodyCell>
                <TableBodyCell>
                  <Typography variant="body2" fontWeight="bold" sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    />
                    {(finalTotalData?.totalExpenditure ?? 0).toLocaleString("en-IN")}
                  </Typography>
                </TableBodyCell>
                <TableBodyCell>
                  <Typography variant="body2" fontWeight="bold" sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    />
                    {(finalTotalData?.balance ?? 0).toLocaleString("en-IN")}
                  </Typography>
                </TableBodyCell>
              </VoucherTableBodyRow>
            </TableBody>
...
export default AccountCopyDayBook;
